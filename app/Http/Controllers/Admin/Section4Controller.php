...
class Section4Controller extends Controller
{
    protected $data = [
        'folder' => 'admin.',
        'Models' => 'App\Models\SectionFour',
        'route' => 'admin/SectionFour',
        'folderBlade' => 'SectionFour',
        'folderImage' => 'SectionFour',
        'fileName' => 'test'
    ];
    ...
    public function store(Request $request)
    {
        if($request->file('photo')){
            ...
            $file-> move(public_path('admin/assets/section4'), $filenamePage);
        }
