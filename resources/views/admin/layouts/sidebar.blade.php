        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    ...
                    <div class="user-profile dropdown m-t-20">
                        ...
                        <div class="user-content hide-menu m-t-10">
                            ...
                            <a href="javascript:void(0)" title="تسجيل الخروج" class="btn btn-circle btn-sm">
                ...
                <li class="nav-small-cap">
                    ...
                    <span class="hide-menu">مرحبا بك في لوحه التحكم</span>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                        <i class="icon-Car-Wheel"></i>
                        <span class="hide-menu">الصفحه الرئسيه </span>
                    </a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        <li class="sidebar-item">
                            ...
                            <a href="{{ route('showSetting') }}" class="sidebar-link">
                                <i class="icon-Record"></i>
                                <span class="hide-menu"> الاعدادات الرئسيه </span>
                            </a>
                        </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                        ...
                        <span class="hide-menu">جميع البيانات  </span>
                    </a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        <li class="sidebar-item">
                            <a href="{{ route('custmoer.index') }}" class="sidebar-link">
                                <i class="mdi mdi-book-multiple"></i>
                                <span class="hide-menu ml-5"> جميع البيانات  </span> <span class="badge badge-pill badge-info">{{ DB::table('customers')->select('*')->count() }}</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{ route('custmoer.create') }}" class="sidebar-link">
                                <i class="mdi mdi-book-multiple"></i>
                                <span class="hide-menu ml-5"> بيانات يوميه </span> <span class="badge badge-pill badge-primary">{{ DB::table('customers')->where('data',date('Y-m-d'))->count() }}</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item">
                            <a href="{{ route('upload_custmer') }}" class="sidebar-link">
                                ...
                                <span class="hide-menu"> رفع بيانات جديده </span>
                            </a>
                        </li>
                    </ul>
                </li>
