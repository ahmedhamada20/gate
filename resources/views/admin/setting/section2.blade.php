    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <button class="btn btn-success" data-toggle="modal" data-target="#createsection2">اضافه جديده</button>
                <!-- Modal -->
                <div class="modal fade" id="createsection2" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="" class="btn btn-success" data-toggle="modal"
                                        data-target="#editSection2{{$row->id}}">edit</a>
                                    <form action="{{route('section2.destroy',$row->id)}}" method="post">
                                        @method('DELETE')
                                        @csrf
                                ...
                                {{-- Start edit --}}
                                <div class="modal fade" id="editSection2{{$row->id}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('section2.update',$row->id)}}" method="post"
                                                   ...
                                                   <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <img src="{{asset('admin/assets/section2/'.$row->cover_photo)}}"
