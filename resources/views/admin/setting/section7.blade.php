    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <button class="btn btn-success" data-toggle="modal" data-target="#createsection7">اضافه جديده</button>
                <!-- Modal -->
                <div class="modal fade" id="createsection7" tabindex="-1" aria-labelledby="exampleModalLabel"
                     aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('section7.store')}}" method="post" autocomplete="off"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="" class="btn btn-success" data-toggle="modal"
                                       data-target="#editSection7{{$row->id}}">edit</a>
                                    <form action="{{route('section7.destroy',$row->id)}}" method="post">
                                        @method('DELETE')
                                        @csrf
                                ...
                                {{--  Start  edit   --}}
                                <div class="modal fade" id="editSection7{{$row->id}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('section7.update',$row->id)}}" method="post"
