    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <button class="btn btn-success" data-toggle="modal" data-target="#createsection4">اضافه جديده</button>
                <!-- Modal -->
                <div class="modal fade" id="createsection4" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('section4.store')}}" method="post" autocomplete="off"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="" class="btn btn-success" data-toggle="modal"
                                        data-target="#editSection4{{$row->id}}">edit</a>
                                    <form action="{{route('section4.destroy',$row->id)}}" method="post">
                                        @method('DELETE')
                                        @csrf
                                ...
                                {{-- Start edit --}}
                                <div class="modal fade" id="editSection4{{$row->id}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('section4.update',$row->id)}}" method="post"
